...
for setting in ["native", "proteus"]:
    ...
    plt.bar(x - 2 * bar_width, df_u50_slow[setting]["average"].values, width=bar_width, label=f"U50 HBM 200 MHz")
    plt.bar(x - 1 * bar_width, df_u280_slow[setting]["average"].values, width=bar_width, label=f"U280 HBM 200 MHz")
    plt.bar(x                , df_u280_ddr_slow[setting]["average"].values, width=bar_width, label=f"U280 DDR 200 MHz")
    ...
    plt.bar(x - 2 * bar_width, df_u50_slow[setting]["transfer+kernel"].values, width=bar_width, label="U50 HBM 200 MHz")
    plt.bar(x - 1 * bar_width, df_u280_slow[setting]["transfer+kernel"].values, width=bar_width, label="U280 HBM 200 MHz")
    plt.bar(x                , df_u280_ddr_slow[setting]["transfer+kernel"].values, width=bar_width, label="U280 DDR 200 MHz")
