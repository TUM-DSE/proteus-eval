...
for setting in ["native", "proteus"]:
    ...
    df_u50_slow[setting] = pd.read_csv(
        f"../data/{setting}/u50-slow-rosetta.csv", skipinitialspace=True)
    df_u50_fast[setting] = pd.read_csv(
        f"../data/{setting}/u50-fast-rosetta.csv", skipinitialspace=True)
    df_u280_slow[setting] = pd.read_csv(
        f"../data/{setting}/u280-slow-rosetta.csv", skipinitialspace=True)
    df_u280_fast[setting] = pd.read_csv(
        f"../data/{setting}/u280-fast-rosetta.csv", skipinitialspace=True)
    df_u280_ddr_slow[setting] = pd.read_csv(
        f"../data/{setting}/u280-ddr-slow-rosetta.csv", skipinitialspace=True)
    df_u280_ddr_fast[setting] = pd.read_csv(
        f"../data/{setting}/u280-ddr-fast-rosetta.csv", skipinitialspace=True)
...
filename = f"../plots/time-rosetta-total.pdf"
print(f"Saving figure to {filename}")
